...
Renderer::Renderer(const std::vector<std::shared_ptr<Util::GameObject>> &children)
    : m_Children(children) {}

void Renderer::AddChild(const std::shared_ptr<Util::GameObject> &child) {
    m_Children.push_back(child);
}

void Renderer::RemoveChild(std::shared_ptr<Util::GameObject> child) {
